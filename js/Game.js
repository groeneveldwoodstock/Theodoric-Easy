...
Theodoric.Game.prototype = {
    ...
    create: function () {
        ...
        this.controls = {
            ...
            spell: this.game.input.keyboard.addKey(Phaser.Keyboard.S),
    ...
    showLabels: function() {
        ...
        style = { font: '15px Arial', fill: '#ffd', align: 'center' };
    ...
    attack: function (attacker, attacks) {
        if (attacker.alive && this.game.time.now > attacks.next && attacks.countDead() > 0) {
            ...
            // Common targeting logic for sword and spells
            if (attacks.name === 'sword' || attacks.name === 'spell') {
                // Find the nearest enemy
                var nearestEnemy = null;
                var minDistance = Infinity;
    
                this.enemies.forEachAlive(function (enemy) {
                    var distance = this.game.math.distance(attacker.x, attacker.y, enemy.x, enemy.y);
                ...
                if (nearestEnemy) {
                    // Make the attack move toward the nearest enemy
                    a.rotation = this.game.physics.arcade.moveToObject(a, nearestEnemy, attacks.range);
                }
                ...
                // Fireball behavior remains unchanged
    ...
    generateSlime: function (enemy) {
        ...
        return this.setStats(enemy, 'Slime', 10, 40, 15, 10, 7);
    },
    ...
    generateBat: function (enemy) {
        ...
        return this.setStats(enemy, 'Bat', 20, 20, 5, 2, 8);
    },
    ...
    generateGhost: function (enemy) {
        ...
        return this.setStats(enemy, 'Ghost', 15, 60, 10, 7, 9);
    },
    ...
    generateSpider: function (enemy) {
        ...
        return this.setStats(enemy, 'Spider', 50, 20, 12, 4, 10);
    },
